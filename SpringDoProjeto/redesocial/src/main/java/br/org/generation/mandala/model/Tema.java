...
public class Tema {
	...
	@Size(min = 10, max = 255, message = "O campo imagem deve conter no minimo 10 e no maximo 255 caracteres.")
	private String imagem;
	
	@NotNull(message = "O campo descrição é obrigatório")
	@Size(min = 10, max = 255, message = "O campo descrição deve conter no minimo 10 e no maximo 255 caracteres.")
